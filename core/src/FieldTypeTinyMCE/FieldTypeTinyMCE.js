...
export class FieldTypeTinyMCE extends React.Component {
  shouldComponentUpdate(nextProps) {
    // when selecting a different version the app state changes
    // and we want to re-render and reflect that state
  ...
  onEditorChange = (content) => {
    this.props.onChange(content, this.props.name, this.props.datatype);
  };

  render() {
    // hold reference to props because editor needs lexical scoping
